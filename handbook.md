...
- Most non-travel purchases should be able to be made by either a company office administrator or your manager; please feel free to make requests as appropriate via these channels. If you do have other items that you'd like to submit for reimbursement, make sure that you have approval from your manager before doing so, and access airbase to submit the expense reimbursements. 
...
**Process to expense** Access airbase to submit the expense reimbursements. 
...
Access airbase to submit the expense reimbursement. Under Category, select "61400 - Professional Development" and list what the item is in the Notes section (example: "Professional Development - Book about Python"). 
